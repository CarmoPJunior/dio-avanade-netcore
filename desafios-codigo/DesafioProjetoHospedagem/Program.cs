...
Suite suite2 = new Suite(tipoSuite: "Premium 2", capacidade: 3, valorDiaria: 30);
...
Console.WriteLine($"Reserva menor que 10 diárias");
Console.WriteLine($"Hóspedes: {reserva.ObterQuantidadeHospedes()}");
Console.WriteLine($"Valor diária: {reserva.CalcularValorDiaria()}");

Console.WriteLine($"Reserva maior igual a 10 diárias");
